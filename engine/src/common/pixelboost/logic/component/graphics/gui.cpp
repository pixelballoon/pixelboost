    ...
    : RenderableComponent<GuiRenderable>(parent)
{
    ...
    _GeometryShader = ResourceManager::Instance()->GetPool("default")->GetResource<ShaderResource>("/shaders/pb_solidColor");
    ...
    _SpriteShader = ResourceManager::Instance()->GetPool("default")->GetResource<ShaderResource>("/shaders/pb_texturedColor");
    ...
    _TextShader = ResourceManager::Instance()->GetPool("default")->GetResource<ShaderResource>("/shaders/pb_texturedColor");

...
void PrimitiveRenderer::AttachEllipse(libpixel::RenderLayer *layer, Vec2 position, Vec2 size, Vec3 rotation, Vec4 color, int segments)
{
    RenderItem item;
...
void PrimitiveRenderer::AttachLine(libpixel::RenderLayer *layer, Vec2 start, Vec2 end, Vec4 color)
{
    RenderItem item;
...
void PrimitiveRenderer::AttachBox(libpixel::RenderLayer *layer, Vec2 position, Vec2 size, Vec3 rotation, Vec4 color, bool solid)
{
    RenderItem item;

...
void Reader::Read_i(ElementTypeT& element, const std::string& str)
{
   Reader reader;
...
inline void Reader::EatWhiteSpace(InputStream& inputStream)
{
   while (inputStream.EOS() == false && 
          (inputStream.Peek() == ' ' || inputStream.Peek() == '\t' || inputStream.Peek() == '\n' || inputStream.Peek() == '\r'))
      inputStream.Get();
}
...
// TODO: Add in number value checking

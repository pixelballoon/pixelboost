...
bool NaclFile::Read(unsigned char* data, int length)
{
    return false;
}
...
bool NaclFile::Write(const unsigned char* data, int length)
{
    return false;
}
...
bool NaclFile::Write(const int& data)
{
    return false;
}

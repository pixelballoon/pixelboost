...
b2Body* Box2DHelpers::CreateBodyFromDefinition(b2World* world, const FixtureDefinition& fixtureDef, const Vec2& position, void* userData)
{
    b2BodyDef bodyDef;

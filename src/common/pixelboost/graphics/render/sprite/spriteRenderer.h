...
public:
    ...
    bool AttachCustom(RenderLayer* layer, const std::string& sheetName, Vec2 size, Vec4 uv, Vec2 position, Vec3 rotation, BlendMode blendMode = kBlendModeNormal, Vec4 tint = Vec4(1.f, 1.f, 1.f, 1.f));

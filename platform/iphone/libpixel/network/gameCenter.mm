...
@private
    ...
    libpixel::GameCenterDelegate* delegate;
}

@property (assign) bool matchStarted;
@property (retain) GKMatch* currentMatch;
@property (assign) libpixel::GameCenterDelegate* delegate;
...
@private
    libpixel::GameCenter* gameCenter;
    GKMatchmakerViewController* matchMaker;
    MatchDelegate* matchDelegate;
}

@property (assign) libpixel::GameCenter* gameCenter;
...
void GameCenter::FindMatch(int group)
{
    ...
    UIViewController* view = (UIViewController*)libpixel::Game::Instance()->GetViewController();
